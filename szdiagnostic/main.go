...
var IDMessages = map[int]string{
	1:    "Enter " + Prefix + "CheckRepositoryPerformance(%d).",
	2:    "Exit  " + Prefix + "CheckRepositoryPerformance(%d) returned (%s, %v).",
	...
	7:    "Enter " + Prefix + "GetRepositoryInfo().",
	8:    "Exit  " + Prefix + "GetRepositoryInfo() returned (%s, %v).",
	...
	4001: Prefix + "SzDiagnostic_checkRepositoryPerformance(%d) failed. Return code: %d",
	4002: Prefix + "SzDiagnostic_destroy() failed.  Return code: %d",
	4003: Prefix + "SzDiagnostic_getRepositoryInfo() failed. Return code: %d",
	...
	8001: Prefix + "CheckRepositoryPerformance",
	8002: Prefix + "Destroy",
	8003: Prefix + "GetRepositoryInfo",
