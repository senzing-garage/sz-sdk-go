...
var testCases = []struct {
	...
	{ // 24
		...
		actual:   SZ_ENTITY_INCLUDE_INTERNAL_FEATURES,
		expected: 0x0000000000800000,
	},
	{ // 25
		name:     "SZ_ENTITY_INCLUDE_FEATURE_STATS",
		actual:   SZ_ENTITY_INCLUDE_FEATURE_STATS,
	...
	{ // 31
		...
		actual:   SZ_FIND_PATH_INCLUDE_MATCHING_INFO,
