...
const (
	...
	SZ_ENTITY_OPTION_INCLUDE_INTERNAL_FEATURES // 23 include internal features
	SZ_ENTITY_OPTION_INCLUDE_FEATURE_STATS     // 24 include statistics on features
	...
	SZ_FIND_PATH_MATCHING_INFO                 // 30 include matching info on entity paths
	SZ_ENTITY_INCLUDE_RECORD_UNMAPPED_DATA     // 31 include the record unmapped data for the entity
	SZ_ENTITY_OPTION_INCLUDE_FEATURE_ELEMENTS  // 32 include feature elements
	SZ_FIND_NETWORK_MATCHING_INFO              // 33 include matching info on entity networks
	SZ_ENTITY_OPTION_INCLUDE_MATCH_KEY_DETAILS // 34 include internal features
	BIT_36                                     // 35
	BIT_37                                     // 36
	BIT_38                                     // 37
	BIT_39                                     // 38
...
const (
	...
	SZ_SEARCH_INCLUDE_FEATURE_SCORES    = SZ_INCLUDE_FEATURE_SCORES                  // Include feature scores from search results
	SZ_SEARCH_INCLUDE_MATCH_KEY_DETAILS = SZ_ENTITY_OPTION_INCLUDE_MATCH_KEY_DETAILS // Include detailed match key in search results.
	...
	SZ_SEARCH_BY_ATTRIBUTES_ALL            = SZ_ENTITY_INCLUDE_ENTITY_NAME | SZ_ENTITY_INCLUDE_RECORD_SUMMARY | SZ_ENTITY_INCLUDE_REPRESENTATIVE_FEATURES | SZ_SEARCH_INCLUDE_ALL_ENTITIES | SZ_SEARCH_INCLUDE_FEATURE_SCORES                               // The recommended flag values for searching by attributes, returning all matching entities.
	...
	SZ_SEARCH_BY_ATTRIBUTES_STRONG         = SZ_ENTITY_INCLUDE_ENTITY_NAME | SZ_ENTITY_INCLUDE_RECORD_SUMMARY | SZ_ENTITY_INCLUDE_REPRESENTATIVE_FEATURES | SZ_SEARCH_INCLUDE_FEATURE_SCORES | SZ_SEARCH_INCLUDE_POSSIBLY_SAME | SZ_SEARCH_INCLUDE_RESOLVED // The recommended flag values for searching by attributes, returning only strongly matching entities.
	...
	SZ_FIND_NETWORK_DEFAULT_FLAGS         = SZ_ENTITY_INCLUDE_ENTITY_NAME | SZ_ENTITY_INCLUDE_RECORD_SUMMARY | SZ_FIND_NETWORK_MATCHING_INFO                                                                                                                                                                                                                                                     // The recommended default flag values for finding entity paths.
	SZ_FIND_PATH_DEFAULT_FLAGS            = SZ_ENTITY_INCLUDE_ENTITY_NAME | SZ_ENTITY_INCLUDE_RECORD_SUMMARY | SZ_FIND_PATH_MATCHING_INFO                                                                                                                                                                                                                                                        // The recommended default flag values for finding entity paths.
	...
	SZ_WHY_ENTITIES_DEFAULT_FLAGS         = SZ_ENTITY_DEFAULT_FLAGS | SZ_ENTITY_OPTION_INCLUDE_FEATURE_STATS | SZ_ENTITY_OPTION_INCLUDE_INTERNAL_FEATURES | SZ_INCLUDE_FEATURE_SCORES
	SZ_WHY_RECORD_IN_ENTITY_DEFAULT_FLAGS = SZ_ENTITY_DEFAULT_FLAGS | SZ_ENTITY_OPTION_INCLUDE_FEATURE_STATS | SZ_ENTITY_OPTION_INCLUDE_INTERNAL_FEATURES | SZ_INCLUDE_FEATURE_SCORES // The recommended default flag values for why-analysis on entities.
	SZ_WHY_RECORDS_DEFAULT_FLAGS          = SZ_ENTITY_DEFAULT_FLAGS | SZ_ENTITY_OPTION_INCLUDE_FEATURE_STATS | SZ_ENTITY_OPTION_INCLUDE_INTERNAL_FEATURES | SZ_INCLUDE_FEATURE_SCORES // The recommended default flag values for why-analysis on entities.
)
