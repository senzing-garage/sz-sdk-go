...
var IdMessages = map[int]string{
	...
	2038: "Call to G2_getLastException() failed. Return code: %d",
	2039: "Call to G2_getRecord(%s, %s) failed. Return code: %d",
	2040: "Call to G2_getRecord_V2(%s, %s, %d) failed. Return code: %d",
	2041: "Call to G2_getRedoRecord() failed. Return code: %d",
	2042: "Call to G2_getRepositoryLastModifiedTime() failed. Return code: %d",
	2043: "Call to G2_getVirtualEntityByRecordID(%s) failed. Return code: %d",
	2044: "Call to G2_getVirtualEntityByRecordID_V2(%s, %d) failed. Return code: %d",
	2045: "Call to G2_howEntityByEntityID(%d) failed. Return code: %d",
	2046: "Call to G2_howEntityByEntityID_V2(%d, %d) failed. Return code: %d",
	2047: "Call to G2_init(%s, %s, %d) failed. Return code: %d",
	2048: "Call to G2_initWithConfigID(%s, %s, %d, %d) failed. Return code: %d",
	2049: "Call to G2_primeEngine() failed. Return code: %d",
	2050: "Call to G2_process(%s) failed. Return code: %d",
	2051: "Call to G2_processRedoRecord() failed. Return code: %d",
	2052: "Call to G2_processRedoRecordWithInfo(%d) failed. Return code: %d",
	2053: "Call to G2_processWithInfo(%s, %d) failed. Return code: %d",
	2054: "Call to G2_processWithResponse(%s) failed. Return code: %d",
	2055: "Call to G2_processWithResponseResize(%s) failed. Return code: %d",
	2056: "Call to G2_purgeRepository() failed. Return code: %d",
	2057: "Call to G2_reevaluateEntity(%d, %d) failed. Return code: %d",
	2058: "Call to G2_reevaluateEntityWithInfo(%d, %d) failed. Return code: %d",
	2059: "Call to G2_reevaluateRecord(%s, %s, %d) failed. Return code: %d",
	2060: "Call to G2_reevaluateRecordWithInfo(%s, %s, %d) failed. Return code: %d",
	2061: "Call to G2_reinit(%d) failed. Return code: %d",
	2062: "Call to G2_replaceRecord(%s, %s, %s, %s) failed. Return code: %d",
	2063: "Call to G2_replaceRecordWithInfo(%s, %s, %s, %s, %d) failed. Return code: %d",
	2064: "Call to G2_searchByAttributes(%s) failed. Return code: %d",
	2065: "Call to G2_searchByAttributes_V2(%s, %d) failed. Return code: %d",
	2066: "Call to G2_stats() failed. Return code: %d",
	2067: "Call to G2_whyEntities(%d, %d) failed. Return code: %d",
	2068: "Call to G2_whyEntities_V2(%d, %d, %d) failed. Return code: %d",
	2069: "Call to G2_whyEntityByEntityID(%d) failed. Return code: %d",
	2070: "Call to G2_whyEntityByEntityID_V2(%d, %d) failed. Return code: %d",
	2071: "Call to G2_whyEntityByRecordID(%s, %s) failed. Return code: %d",
	2072: "Call to G2_whyEntityByRecordID_V2(%s, %s, %d) failed. Return code: %d",
	2073: "Call to G2_whyRecords(%s, %s, %s, %s) failed. Return code: %d",
	2074: "Call to G2_whyRecords_V2(%s, %s, %s, %s, %d) failed. Return code: %d",
