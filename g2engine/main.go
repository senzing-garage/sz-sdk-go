...
var IdMessages = map[int]string{
	...
	2006: "Call to G2_closeExport() failed. Return code: %d",
	...
	2014: "Call to G2_fetchNext() failed. Return code: %d",
	...
	4004: "Exit  AddRecordWithInfo(%s, %s, %s, %s, %d) returned (%v).",
	4005: "Enter AddRecordWithInfoWithReturnedRecordID(%s, %s, %s, %d).",
	4006: "Exit  AddRecordWithInfoWithReturnedRecordID(%s, %s, %s, %d) returned (%v).",
	4007: "Enter AddRecordWithReturnedRecordID(%s, %s, %s).",
	4008: "Exit  AddRecordWithReturnedRecordID(%s, %s, %s) returned (%v).",
	4009: "Enter CheckRecord(%s, %s).",
	4010: "Exit  CheckRecord(%s, %s) returned (%v).",
	4011: "Enter ClearLastException(%s, %s).",
	4012: "Exit  ClearLastException(%s, %s) returned (%v).",
	4013: "Enter CloseExport().",
	4014: "Exit  CloseExport() returned (%v).",
	4015: "Enter CountRedoRecords().",
	4016: "Exit  CountRedoRecords() returned (%v).",
	4017: "Enter DeleteRecord(%s, %s, %s).",
	4018: "Exit  DeleteRecord(%s, %s, %s) returned (%v).",
	4019: "Enter DeleteRecordWithInfo(%s, %s, %s, %d).",
	4020: "Exit  DeleteRecordWithInfo(%s, %s, %s, %d) returned (%v).",
	4021: "Enter Destroy().",
	4022: "Exit  Destroy() returned (%v).",
	4023: "Enter ExportConfigAndConfigID().",
	4024: "Exit  ExportConfigAndConfigID() returned (%v).",
	4025: "Enter ExportConfig().",
	4026: "Exit  ExportConfig() returned (%v).",
	4027: "Enter ExportCSVEntityReport(%s, %d).",
	4028: "Exit  ExportCSVEntityReport(%s, %d) returned (%v).",
	4029: "Enter ExportJSONEntityReport(%d).",
	4030: "Exit  ExportJSONEntityReport(%d) returned (%v).",
	4031: "Enter FetchNext().",
	4032: "Exit  FetchNext() returned (%v).",
	4033: "Enter FindInterestingEntitiesByEntityID(%d, %d).",
	4034: "Exit  FindInterestingEntitiesByEntityID(%d, %d) returned (%v).",
	4035: "Enter FindInterestingEntitiesByRecordID(%s, %s, %d).",
	4036: "Exit  FindInterestingEntitiesByRecordID(%s, %s, %d) returned (%v).",
	4037: "Enter FindNetworkByEntityID(%s, %d, %d, %d).",
	4038: "Exit  FindNetworkByEntityID(%s, %d, %d, %d) returned (%v).",
	4039: "Enter FindNetworkByEntityID_V2(%s, %d, %d, %d, %d).",
	4040: "Exit  FindNetworkByEntityID_V2(%s, %d, %d, %d, %d) returned (%v).",
	4041: "Enter FindNetworkByRecordID(%s, %d, %d, %d).",
	4042: "Exit  FindNetworkByRecordID(%s, %d, %d, %d) returned (%v).",
	4043: "Enter FindNetworkByRecordID_V2(%s, %d, %d, %d, %d).",
	4044: "Exit  FindNetworkByRecordID_V2(%s, %d, %d, %d, %d) returned (%v).",
	4045: "Enter FindPathByEntityID(%d, %d, %d).",
	4046: "Exit  FindPathByEntityID(%d, %d, %d) returned (%v).",
	4047: "Enter FindPathByEntityID_V2(%d, %d, %d, %d).",
	4048: "Exit  FindPathByEntityID_V2(%d, %d, %d, %d) returned (%v).",
	4049: "Enter FindPathByRecordID(%s, %s, %s, %s, %d).",
	4050: "Exit  FindPathByRecordID(%s, %s, %s, %s, %d) returned (%v).",
	4051: "Enter FindPathByRecordID_V2(%s, %s, %s, %s, %d, %d).",
	4052: "Exit  FindPathByRecordID_V2(%s, %s, %s, %s, %d, %d) returned (%v).",
	4053: "Enter FindPathExcludingByEntityID(%d, %d, %d, %s).",
	4054: "Exit  FindPathExcludingByEntityID(%d, %d, %d, %s) returned (%v).",
	4055: "Enter FindPathExcludingByEntityID_V2(%d, %d, %d, %s, %d).",
	4056: "Exit  FindPathExcludingByEntityID_V2(%d, %d, %d, %s, %d) returned (%v).",
	4057: "Enter FindPathExcludingByRecordID(%s, %s, %s, %s %d, %s).",
	4058: "Exit  FindPathExcludingByRecordID(%s, %s, %s, %s %d, %s) returned (%v).",
	...
	4062: "Exit  FindPathIncludingSourceByEntityID(%d, %d, %d, %s, %s) returned (%v).",
	4063: "Enter FindPathIncludingSourceByEntityID_V2(%d, %d, %d, %s, %s, %d).",
	4064: "Exit  FindPathIncludingSourceByEntityID_V2(%d, %d, %d, %s, %s, %d) returned (%v).",
	4065: "Enter FindPathIncludingSourceByRecordID(%s, %s, %s, %s %d, %s, %s).",
	4066: "Exit  FindPathIncludingSourceByRecordID(%s, %s, %s, %s %d, %s, %s) returned (%v).",
	4067: "Enter FindPathIncludingSourceByRecordID_V2(%s, %s, %s, %s %d, %s, %s, %d).",
	4068: "Exit  FindPathIncludingSourceByRecordID_V2(%s, %s, %s, %s %d, %s, %s, %d) returned (%v).",
	4069: "Enter GetActiveConfigID().",
	4070: "Exit  GetActiveConfigID() returned (%v).",
	4071: "Enter GetEntityByEntityID(%d).",
	4072: "Exit  GetEntityByEntityID(%d) returned (%v).",
	4073: "Enter GetEntityByEntityID_V2(%d, %d).",
	4074: "Exit  GetEntityByEntityID_V2(%d, %d) returned (%v).",
	4075: "Enter GetEntityByRecordID(%s, %s).",
	4076: "Exit  GetEntityByRecordID(%s, %s) returned (%v).",
	4077: "Enter GetEntityByRecordID_V2(%s, %s, %d).",
	4078: "Exit  GetEntityByRecordID_V2(%s, %s, %d) returned (%v).",
	4079: "Enter GetLastException().",
	4080: "Exit  GetLastException() returned (%v).",
	4081: "Enter GetLastExceptionCode().",
	4082: "Exit  GetLastExceptionCode() returned (%v).",
	4083: "Enter GetRecord(%s, %s).",
	4084: "Exit  GetRecord(%s, %s) returned (%v).",
	4085: "Enter GetRecord_V2(%s, %s, %d).",
	4086: "Exit  GetRecord_V2(%s, %s, %d) returned (%v).",
	4087: "Enter GetRedoRecord().",
	4088: "Exit  GetRedoRecord() returned (%v).",
	4089: "Enter GetRepositoryLastModifiedTime().",
	4090: "Exit  GetRepositoryLastModifiedTime() returned (%v).",
	4091: "Enter GetVirtualEntityByRecordID(%s).",
	4092: "Exit  GetVirtualEntityByRecordID(%s) returned (%v).",
	4093: "Enter GetVirtualEntityByRecordID_V2(%s, %d).",
	4094: "Exit  GetVirtualEntityByRecordID_V2(%s, %d) returned (%v).",
	4095: "Enter HowEntityByEntityID(%d).",
	4096: "Exit  HowEntityByEntityID(%d) returned (%v).",
	4097: "Enter HowEntityByEntityID_V2(%d, %d).",
	4098: "Exit  HowEntityByEntityID_V2(%d, %d) returned (%v).",
	...
	4108: "Exit  ProcessRedoRecord() returned (%v).",
	4109: "Enter ProcessRedoRecordWithInfo(%d).",
	4110: "Exit  ProcessRedoRecordWithInfo(%d) returned (%v).",
	4111: "Enter ProcessWithInfo(%s, %d).",
	4112: "Exit  ProcessWithInfo(%s, %d) returned (%v).",
	4113: "Enter ProcessWithResponse(%s).",
	4114: "Exit  ProcessWithResponse(%s) returned (%v).",
	4115: "Enter ProcessWithResponseResize(%s).",
	4116: "Exit  ProcessWithResponseResize(%s) returned (%v).",
	...
	4132: "Exit  ReplaceRecordWithInfo(%s, %s, %s, %s, %d) returned (%v).",
	4133: "Enter SearchByAttributes(%s).",
	4134: "Exit  SearchByAttributes(%s) returned (%v).",
	4135: "Enter SearchByAttributes_V2(%s, %d).",
	4136: "Exit  SearchByAttributes_V2(%s, %d) returned (%v).",
	4137: "Enter Stats().",
	4138: "Exit  Stats() returned (%v).",
	4139: "Enter WhyEntities(%d, %d).",
	4140: "Exit  WhyEntities(%d, %d) returned (%v).",
	4141: "Enter WhyEntities_V2(%d, %d, %d).",
	4142: "Exit  WhyEntities_V2(%d, %d, %d) returned (%v).",
	4143: "Enter WhyEntityByEntityID(%d).",
	4144: "Exit  WhyEntityByEntityID(%d) returned (%v).",
	4145: "Enter WhyEntityByEntityID_V2(%d, %d).",
	4146: "Exit  WhyEntityByEntityID_V2(%d, %d) returned (%v).",
	4147: "Enter WhyEntityByRecordID(%s, %s).",
	4148: "Exit  WhyEntityByRecordID(%s, %s) returned (%v).",
	4149: "Enter WhyEntityByRecordID_V2(%s, %s, %d).",
	4150: "Exit  WhyEntityByRecordID_V2(%s, %s, %d) returned (%v).",
	4151: "Enter WhyRecords(%s, %s, %s, %s).",
	4152: "Exit  WhyRecords(%s, %s, %s, %s) returned (%v).",
	4153: "Enter WhyRecords_V2(%s, %s, %s, %s, %d).",
	4154: "Exit  WhyRecords_V2(%s, %s, %s, %s, %d) returned (%v).",
}
