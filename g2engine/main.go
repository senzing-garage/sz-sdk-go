...
var IdMessages = map[int]string{
	...
	4137: "Enter Stats().",
	4138: "Exit  Stats() returned (%s, %v).",
	4139: "Enter WhyEntities(%d, %d).",
	4140: "Exit  WhyEntities(%d, %d) returned (%s, %v).",
	4141: "Enter WhyEntities_V2(%d, %d, %d).",
	4142: "Exit  WhyEntities_V2(%d, %d, %d) returned (%s, %v).",
	4143: "Enter WhyEntityByEntityID(%d).",
	4144: "Exit  WhyEntityByEntityID(%d) returned (%s, %v).",
	4145: "Enter WhyEntityByEntityID_V2(%d, %d).",
	4146: "Exit  WhyEntityByEntityID_V2(%d, %d) returned (%s, %v).",
	4147: "Enter WhyEntityByRecordID(%s, %s).",
	4148: "Exit  WhyEntityByRecordID(%s, %s) returned (%s, %v).",
	4149: "Enter WhyEntityByRecordID_V2(%s, %s, %d).",
	4150: "Exit  WhyEntityByRecordID_V2(%s, %s, %d) returned (%s, %v).",
	4151: "Enter WhyRecords(%s, %s, %s, %s).",
	4152: "Exit  WhyRecords(%s, %s, %s, %s) returned (%s, %v).",
	4153: "Enter WhyRecords_V2(%s, %s, %s, %s, %d).",
	4154: "Exit  WhyRecords_V2(%s, %s, %s, %s, %d) returned (%s, %v).",
}
