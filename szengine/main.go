...
var IDMessages = map[int]string{
	...
	5:    "Enter " + Prefix + "CloseExportReport(%v).",
	6:    "Exit  " + Prefix + "CloseExportReport(%v) returned (%v).",
	...
	23:   "Enter " + Prefix + "FindInterestingEntitiesByEntityID(%d, %d).",
	24:   "Exit  " + Prefix + "FindInterestingEntitiesByEntityID(%d, %d) returned (%s, %v).",
	...
	77:   "Enter " + Prefix + "GetRecordPreview(%s, %d).",
	78:   "Exit  " + Prefix + "GetRecordPreview(%s, %d) returned (%s, %v).",
	...
	4021: Prefix + "Sz_findPathByEntityIDWithAvoids_V2(%d, %d, %d, %s, %d) failed. Return code: %d",
	4022: Prefix + "Sz_findPathExcludingByRecordID(%s, %s, %s, %s %d, %s) failed. Return code: %d",
	4023: Prefix + "Sz_findPathByRecordIDWithAvoids_V2(%s, %s, %s, %s %d, %s, %d) failed. Return code: %d",
	4024: Prefix + "Sz_findPathIncludingSourceByEntityID(%d, %d, %d, %s, %s) failed. Return code: %d",
	4025: Prefix + "Sz_findPathByEntityIDIncludingSource_V2(%d, %d, %d, %s, %s, %d) failed. Return code: %d",
	4026: Prefix + "Sz_findPathIncludingSourceByRecordID(%s, %s, %s, %s, %d, %s, %s) failed. Return code: %d",
	4027: Prefix + "Sz_findPathByRecordIDIncludingSource_V2(%s, %s, %s, %s, %d, %s, %s, %d) failed. Return code: %d",
	...
	4062: Prefix + "Sz_countRedoRecords() failed. Return code: %d",
	4063: Prefix + "Sz_whySearch(%s, %d, %s) failed. Return code: %d",
	4064: Prefix + "Sz_whySearch_V2(%s, %d, %s, %d) failed. Return code: %d",
	8001: Prefix + "AddRecord",
	8002: Prefix + "CloseExportReport",
	...
	8035: Prefix + "GetRecordPreview",
	8036: Prefix + "WhySearch",
