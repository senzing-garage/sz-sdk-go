...
var IDMessages = map[int]string{
	1:    "Enter " + Prefix + "RegisterDataSource(%s).",
	2:    "Exit  " + Prefix + "RegisterDataSource(%s) returned (%s, %v).",
	...
	9:    "Enter " + Prefix + "UnregisterDataSource(%s).",
	10:   "Exit  " + Prefix + "UnregisterDataSource(%s) returned (%v).",
	11:   "Enter " + Prefix + "Destroy().",
	12:   "Exit  " + Prefix + "Destroy() returned (%v).",
	13:   "Enter " + Prefix + "Export().",
	14:   "Exit  " + Prefix + "Export() returned (%s, %v).",
	15:   "Enter " + Prefix + "GetDataSourceRegistry().",
	16:   "Exit  " + Prefix + "GetDataSourceRegistry() returned (%s, %v).",
	...
	8001: Prefix + "RegisterDataSource",
	8002: Prefix + "CloseConfig",
	8003: Prefix + "ImportTemplate",
	8004: Prefix + "UnregisterDataSource",
	8005: Prefix + "Destroy",
	8006: Prefix + "Export",
	8007: Prefix + "Initialize",
	8008: Prefix + "GetDataSourceRegistry",
	8009: Prefix + "Import",
