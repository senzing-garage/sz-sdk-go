...
var IdMessages = map[int]string{
	...
	2005: "Call to G2Config_getLastException() failed. Return code: %d",
	2006: "Call to G2Config_destroy() failed. Return code: %d",
	2007: "Call to G2Config_init(%s, %s, %d) failed. Return code: %d",
	2008: "Call to G2Config_listDataSources() failed. Return code: %d",
	2009: "Call to G2Config_load(%v, %s) failed. Return code: %d",
	2010: "Call to G2Config_save(%v) failed. Return code: %d",
