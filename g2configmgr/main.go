...
var IdMessages = map[int]string{
	...
	2002: "Call to G2ConfigMgr_destroy() failed. Return code: %d",
	...
	2006: "Call to G2ConfigMgr_getLastException() failed. Return code: %d",
	2007: "Call to G2ConfigMgr_init(%s, %s, %d) failed. Return code: %d",
